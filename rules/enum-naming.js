...
export default {
    meta: {
        type: 'suggestion',
        docs: {
            description: 'Перечисления должны использовать имена PascalCase и ключи UPPER_SNAKE_CASE',
        },
        schema: [],
        messages: {
            enumNameNotPascal: 'Имя перечисления "{{name}}" должно быть в PascalCase',
            enumKeyNotUpperSnake: 'Ключ перечисления "{{key}}" должен быть в UPPER_SNAKE_CASE',
        },
    },
